...
export const KanbanMain = ({todoTasks, doingTasks, doneTasks, setTodoTasks, setDoingTasks, setDoneTasks}: {
    ...
    const handleAddTask = (type: TaskType, task: TaskItem) => {
        updateMap[type]((tasks: TaskItem[]) => [task, ...tasks]);
    };
